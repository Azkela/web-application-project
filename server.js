...
app.get("/user/:username/avatar0", middleware, (req, res) => {
    model.setUserAvatar0(req.session.user);
    res.redirect("/user/" + req.session.user);
});

app.get("/user/:username/avatar1", middleware, (req, res) => {
    model.setUserAvatar1(req.session.user);
    res.redirect("/user/" + req.session.user);
});

app.get("/user/:username/avatar2", middleware, (req, res) => {
    model.setUserAvatar2(req.session.user);
    res.redirect("/user/" + req.session.user);
});
